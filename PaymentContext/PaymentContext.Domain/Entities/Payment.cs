    ...
    public abstract class Payment : Entity
    {
        protected Payment(DateTime paidDate, DateTime expireDate, decimal total, decimal totalPaid, string payer, Document document, Address adress, Email email)
        {
            ...
            AddNotifications(new Contract()
                .Requires()
                .IsLowerOrEqualsThan(0, Total, "Payment.Total", "O total não pdoe ser zero")
                .IsGreaterOrEqualsThan(Total, TotalPaid, "Payment.Total", "O total pago é menor que o valor do pagamento")
            );
        }
